    ...
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS volunteer_assignments (
            ...
            CREATE TABLE IF NOT EXISTS donations (
                ...
                status VARCHAR(25) NOT NULL DEFAULT 'available', -- available, pending, fulfilled
            ...
            CREATE TABLE IF NOT EXISTS donation_items (
                ...
                status VARCHAR(25) NOT NULL DEFAULT 'available', -- available, pending allocation, fully allocated
            ...
            CREATE TABLE IF NOT EXISTS allocations (
                ...
                status VARCHAR(25) NOT NULL DEFAULT 'pending', -- pending, fulfilled
