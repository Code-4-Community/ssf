  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            ALTER TABLE pantries
                ...
                ADD COLUMN mailing_address_line_1 varchar(255),
                ADD COLUMN mailing_address_line_2 varchar(255),
                ADD COLUMN mailing_address_city varchar(255),
                ADD COLUMN mailing_address_state varchar(255),
                ADD COLUMN mailing_address_zip varchar(255),
                ADD COLUMN mailing_address_country varchar(255),
                ALTER COLUMN newsletter_subscription DROP NOT NULL,
                ADD COLUMN has_email_contact BOOLEAN NOT NULL,
                ADD COLUMN has_email_contact_other TEXT,
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            ALTER TABLE "pantries" 
                ...
                DROP COLUMN IF EXISTS has_email_contact_other,
