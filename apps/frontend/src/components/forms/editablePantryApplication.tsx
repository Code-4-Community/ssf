  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const formData: UpdatePantryApplicationDto = {
        ...
        shipmentAddressLine2: form.shipmentLine2 || null,
        ...
        shipmentAddressCountry: form.shipmentCountry || null,
        mailingAddressLine1: form.mailingLine1 || undefined,
        mailingAddressLine2: form.mailingLine2 || null,
        ...
        mailingAddressCountry: form.mailingCountry || null,
